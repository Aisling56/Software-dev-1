...
public class HW2 {
    ...
    // this loop never stops because it will run while run == true, and run is always equal to true. to break out of the loop after it prints once, we can add run = false tp the end of our while loop so that it will stop.  

        //P5: Take a string from the user and print them the reverse!
        System.out.println("Problem 5");
        //hint
        System.out.println("Give me a word and I will return it to you in reverse");
        input.nextLine();
